...
#define REPORT_SENSOR_MULTILEVEL_VALUE(report_data)			zunoReportFixToFloat(REPORT_SENSOR_MULTILEVEL_SIZE(report_data), REPORT_SENSOR_MULTILEVEL_PRECISION(report_data), &((ZwSensorMultilevelReportFrame_t *)((ReportAuxData_t *)report_data)->rawReportData)->byte1.sensorValue1)
...
#define REPORT_METER_VALUE(report_data)						zunoReportFixToFloat(REPORT_METER_SIZE(report_data), REPORT_METER_PRECISION(report_data), &((ZwMeterReportFrame_t *)((ReportAuxData_t *)report_data)->rawReportData)->v2.byte1.meterValue1)
