...
#define INDICATOR_ID_ARMED										INDICATOR_SET_ARMED_V4
#define INDICATOR_ID_NOT_ARMED									INDICATOR_SET_NOT_ARMED_V4
...
#define INDICATOR_PROP_SUPPORT_MASK								(INDICATOR_PROP_TOGGLING_MASK | INDICATOR_PROP_BINARY_MASK)
