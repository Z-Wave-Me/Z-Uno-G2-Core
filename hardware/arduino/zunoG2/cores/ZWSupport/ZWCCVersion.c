...
static const uint8_t zuno_CCVesrions[] = {
  ...
  COMMAND_CLASS_ZWAVEPLUS_INFO, ZWAVEPLUS_INFO_VERSION_RELEASED,
  ...
  COMMAND_CLASS_SUPERVISION, SUPERVISION_VERSION_RELEASED,
  ...
  COMMAND_CLASS_USER_CREDENTIAL, USER_CREDENTIAL_VERSION_RELEASED,
  #endif
  ...
  COMMAND_CLASS_THERMOSTAT_MODE, THERMOSTAT_MODE_VERSION_RELEASED,
  #endif
  #ifdef WITH_CC_THERMOSTAT_SETPOINT
  COMMAND_CLASS_THERMOSTAT_SETPOINT, THERMOSTAT_SETPOINT_VERSION_RELEASED,
  #endif
  #ifdef WITH_CC_THERMOSTAT_OPERATING_STATE
  COMMAND_CLASS_THERMOSTAT_OPERATING_STATE, THERMOSTAT_OPERATING_STATE_VERSION_RELEASED,
  #endif
  #ifdef WITH_CC_THERMOSTAT_FAN_MODE
  COMMAND_CLASS_THERMOSTAT_FAN_MODE, THERMOSTAT_FAN_MODE_VERSION_RELEASED,
  #endif
    #ifdef WITH_CC_THERMOSTAT_FAN_STATE
  COMMAND_CLASS_THERMOSTAT_FAN_STATE, THERMOSTAT_FAN_STATE_VERSION_RELEASED,
  #endif
  ...
  COMMAND_CLASS_MULTI_CHANNEL, MULTI_CHANNEL_VERSION_RELEASED,
  #endif
