...
enum {
	...
	HANDLER_ARGTYPE_2UB,
	HANDLER_ARGTYPE_4UB,
	HANDLER_ARGTYPE_1SB = HANDLER_ARGTYPE_1UB | 0x08,
	HANDLER_ARGTYPE_2SB = HANDLER_ARGTYPE_2UB | 0x08,
	HANDLER_ARGTYPE_4SB = HANDLER_ARGTYPE_4UB | 0x08
};
...
enum
{
	...
	CHANNEL_HANDLER_SINGLE_WINDOWCOVERING = CHANNEL_HANDLER_SINGLE_GETTERSETTER_2P,
	CHANNEL_HANDLER_MULTI_WINDOWCOVERING = CHANNEL_HANDLER_MULTI_GETTERSETTER_2P
};
