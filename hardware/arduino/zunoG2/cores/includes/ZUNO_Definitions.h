...
#define NOTIFICATION_EVENT_BAT_IS_CHARGING				0x0c
#define NOTIFICATION_EVENT_BAT_IS_FULL_CHARGING			0x0d
#define NOTIFICATION_EVENT_CHARGE_BAT_SOON				0x0e
#define NOTIFICATION_EVENT_CHARGE_BAT_NOW				0x0f
#define NOTIFICATION_EVENT_BACK_UP_BAT_IS_LOW			0x10
#define NOTIFICATION_EVENT_BAT_FLUID_IS_LOW				0x11
#define NOTIFICATION_EVENT_BACK_UP_BAT_IS_DISCONNECTED	0x12
...
#define ZUNO_NOTIFICATION_TYPE_FLAG													0x80
#define ZUNO_NOTIFICATION_POWER_MANAGEMENT											(NOTIFICATION_TYPE_POWER_MANAGEMENT_ALARM | ZUNO_NOTIFICATION_TYPE_FLAG)
#define ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_POWER_APPLIED						(NOTIFICATION_EVENT_POWER_APPLIED)
#define ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_AC_DISCONNECTED					(NOTIFICATION_EVENT_AC_DISCONNECTED)
#define ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_AC_RECONNECTED						(NOTIFICATION_EVENT_AC_RECONNECTED)
#define ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_SURGE								(NOTIFICATION_EVENT_SURGE)
#define ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_VOLTAGE_DROP						(NOTIFICATION_EVENT_VOLTAGE_DROP)
#define ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_OVER_CURRENT						(NOTIFICATION_EVENT_OVER_CURRENT)
#define ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_OVER_VOLTAGE						(NOTIFICATION_EVENT_OVER_VOLTAGE)
#define ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_OVER_LOAD							(NOTIFICATION_EVENT_OVER_LOAD)
#define ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_LOAD_ERROR							(NOTIFICATION_EVENT_LOAD_ERROR)
#define ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_REPLACE_BAT_SOON					(NOTIFICATION_EVENT_REPLACE_BAT_SOON)
#define ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_REPLACE_BAT_NOW					(NOTIFICATION_EVENT_REPLACE_BAT_NOW)
#define ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_BAT_IS_CHARGING					(NOTIFICATION_EVENT_BAT_IS_CHARGING)
#define ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_BAT_IS_FULL_CHARGING				(NOTIFICATION_EVENT_BAT_IS_FULL_CHARGING)
#define ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_CHARGE_BAT_SOON					(NOTIFICATION_EVENT_CHARGE_BAT_SOON)
#define ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_CHARGE_BAT_NOW						(NOTIFICATION_EVENT_CHARGE_BAT_NOW)
#define ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_BACK_UP_BAT_IS_LOW					(NOTIFICATION_EVENT_BACK_UP_BAT_IS_LOW)
#define ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_BAT_FLUID_IS_LOW					(NOTIFICATION_EVENT_BAT_FLUID_IS_LOW)
#define ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_BACK_UP_BAT_IS_DISCONNECTED		(NOTIFICATION_EVENT_BACK_UP_BAT_IS_DISCONNECTED)
#define ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_POWER_APPLIED_MASK					(0x1 << ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_POWER_APPLIED)
#define ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_AC_DISCONNECTED_MASK				(0x1 << ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_AC_DISCONNECTED)
#define ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_AC_RECONNECTED_MASK				(0x1 << ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_AC_RECONNECTED)
#define ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_SURGE_MASK							(0x1 << ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_SURGE)
#define ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_VOLTAGE_DROP_MASK					(0x1 << ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_VOLTAGE_DROP)
#define ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_OVER_CURRENT_MASK					(0x1 << ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_OVER_CURRENT)
#define ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_OVER_VOLTAGE_MASK					(0x1 << ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_OVER_VOLTAGE)
#define ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_OVER_LOAD_MASK						(0x1 << ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_OVER_LOAD)
#define ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_LOAD_ERROR_MASK					(0x1 << ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_LOAD_ERROR)
#define ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_REPLACE_BAT_SOON_MASK				(0x1 << ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_REPLACE_BAT_SOON)
#define ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_REPLACE_BAT_NOW_MASK				(0x1 << ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_REPLACE_BAT_NOW)
#define ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_BAT_IS_CHARGING_MASK				(0x1 << ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_BAT_IS_CHARGING)
#define ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_BAT_IS_FULL_CHARGING_MASK			(0x1 << ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_BAT_IS_FULL_CHARGING)
#define ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_CHARGE_BAT_SOON_MASK				(0x1 << ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_CHARGE_BAT_SOON)
#define ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_CHARGE_BAT_NOW_MASK				(0x1 << ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_CHARGE_BAT_NOW)
#define ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_BACK_UP_BAT_IS_LOW_MASK			(0x1 << ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_BACK_UP_BAT_IS_LOW)
#define ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_BAT_FLUID_IS_LOW_MASK				(0x1 << ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_BAT_FLUID_IS_LOW)
#define ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_BACK_UP_BAT_IS_DISCONNECTED_MASK	(0x1 << ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_BACK_UP_BAT_IS_DISCONNECTED)
#define ZUNO_NOTIFICATION_POWER_MANAGEMENT_EVENT_ALL_MASK							(0x7FFFF)
...
#define THERMOSTAT_PROPERTIES_COMBINER(UNITS, POS_NEG, LIMITS, MODES)						(UNITS | POS_NEG | (LIMITS & THERMOSTAT_LIMITS_MASK) | ((MODES) & THERMOSTAT_FLAGS_MASK_PARAM_01))
// Switch color
