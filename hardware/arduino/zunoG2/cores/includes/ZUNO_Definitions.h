...
#define ZUNO_COMMAND_PACKET_CMD_OUT_MAX_RECOMMENDED		32 // For fast work
#define ZUNO_COMMAND_PACKET_CMD_OUT_MAX					(MAX_ZW_PACKAGE - MAX_ZWTRANSPORT_ENCAP)
...
#ifndef ZUNO_AFTER_INCLUSION_SLEEP_TIMEOUT
#define ZUNO_AFTER_INCLUSION_SLEEP_TIMEOUT				5000
#endif 
#ifndef ZUNO_SLEEP_INCLUSION_TIMEOUT
#define ZUNO_SLEEP_INCLUSION_TIMEOUT 					5000
#endif 
#ifndef ZUNO_SLEEP_FLIRS_TIMEOUT
#define ZUNO_SLEEP_FLIRS_TIMEOUT 						2000
#endif 
#define ZUNO_SLEEP_OTA_TIMEOUT 							20000
#define ZUNO_SLEEP_INTERVIEW_TIMEOUT 					15000
#ifndef ZUNO_SLEEP_RX_TIMEOUT
#define ZUNO_SLEEP_RX_TIMEOUT 							2000
#endif
#ifndef ZUNO_SLEEP_TX_TIMEOUT
...
enum{
	INCLUSION_STATE_EXCLUDED,
	INCLUSION_STATE_INCLUDED_UNSECURE,
	INCLUSION_STATE_INCLUDED_SECURE
};
...
enum {
	...
	ZUNO_COMMAND_BLOCKED_FAILL,
	ZUNO_COMMAND_BLOCKED_NO_SUPPORT,
	ZUNO_COMMAND_BLOCKED_WORKING
};
enum{
	SLEEP_MODE_EM0 = 0,
	SLEEP_MODE_EM2 = 1,
...
enum {
	...
	CHANNEL_TYPE_FLAGS_BASIC_MAPPER=0x02,
...
enum{
	...
	HEADER_FLAGS_REBOOT_CFG = 0x100,
	HEADER_FLAGS_ALL_SECURE = 0x200,
	HEADER_FLAGS_ALL_UNSECURE = 0x400
};
#define DEVICE_CONFIGURATION_FLAGS_MASK_SLEEP  0x03
enum{
	ZUNO_SYS_EVENT_START 	= 0x00,
	ZUNO_SYS_EVENT_GOSLEEP 	= 0x01,
	ZUNO_SYS_EVENT_QUICKWAKEUP = 0x02,
	ZUNO_SYS_EVENT_STAY_AWAKE = 0x03,
	...
	ZUNO_SYS_EVENT_SLEEP_MODEEXC = 0x70,
	ZUNO_SYS_EVENT_STACK_OVERFLOW    = 0xA0,
	ZUNO_SYS_EVENT_QUEUE_OVERLOAD     = 0xC0,
	ZUNO_SYS_EVENT_INVALID_TX_REQUEST = 0xD0,
	ZUNO_SYS_EVENT_INVALID_COMMAND = 0xD1,
	ZUNO_SYS_EVENT_INVALID_CLOCK = 0xE0,
	ZUNO_SYS_EVENT_INVALID_MEMORYAREA_IN_SYSCALL = 0xE1,
	ZUNO_SYS_EVENT_INVALID_PARAMNUM_IN_SYSCALL = 0xE2,
	ZUNO_SYS_EVENT_INVALID_SYSCALL_PARAM_VALUE = 0xE3,
	ZUNO_SYS_EVENT_SYSTEM_FAULT = 0xF0,
	ZUNO_SYS_EVENT_SYSTEM_WDOGREBOOT = 0xF1,
	ZUNO_SYS_EVENT_USERCODE_FAILED = 0xF7
...
enum {
	...
	ZUNO_HANDLER_EXTINT,
	ZUNO_HANDLER_GPT,
	ZUNO_HANDLER_NOTIFICATON_TIME_STAMP,
	ZUNO_HANDLER_OBJ_MAPPER,
...
enum {
	PERSISTENT_SYSTIMER = 0x01,
	PERSISTENT_CUSTOMTIMER = 0x02
};
enum{
    FWHEADER_FLAGS_LEGACY_SAPI = 0x01,
    FWHEADER_FLAGS_INVERT_LEDS = 0x02,
    FWHEADER_FLAGS_EXTERNAL_LFQUARTZ = 0x80
};
#define ZUNO_DOOR_LOCK_MODE_UNSECURED_WITH_TIMEOUT									(0x01 << 0x0)
#define ZUNO_DOOR_LOCK_MODE_UNSECURED_FOR_INSIDE_DOOR_HANDLES						(0x01 << 0x1)
#define ZUNO_DOOR_LOCK_MODE_UNSECURED_FOR_INSIDE_DOOR_HANDLES_WITH_TIMEOUT			(0x01 << 0x2)
#define ZUNO_DOOR_LOCK_MODE_UNSECURED_FOR_OUTSIDE_DOOR_HANDLES						(0x01 << 0x3)
#define ZUNO_DOOR_LOCK_MODE_UNSECURED_FOR_OUTSIDE_DOOR_HANDLES_WITH_TIMEOUT			(0x01 << 0x4)
...
#define ZUNO_SENSOR_BINARY_TYPE_SYSTEM_HARDWARE_FAILURE_CODE 	0x16
#define ZUNO_SENSOR_BINARY_TYPE_DVICE_LOCATION_MOVED            0x17
/*		
