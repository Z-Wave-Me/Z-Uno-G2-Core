...
#define ZUNO_METER_TBL_MONITOR(TYPE, RESETABLE,  SCALE, SIZE, PRECISION, GETTER, RESETTER)	{ZUNO_METER_TBL_MONITOR_CHANNEL_NUMBER, TYPE | ((RESETABLE&0x01) << 7), METER_PROPERTIES_COMBINER(SCALE, SIZE, PRECISION), (void*)GETTER, (void*)RESETTER,  (void*)0, (void*)0}
