...
#define ZUNO_WINDOW_COVERING(DEFAULT_ID, PARAMETER_ID, GETTER, SETTER) 						{ZUNO_WINDOW_COVERING_CHANNEL_NUMBER, DEFAULT_ID##_DEFAULT, (PARAMETER_ID & WINDOW_COVERING_PARAMETER_ID_MASK), (void*)GETTER, (void*)SETTER,  (void*)0, (void*)0}
#else
#define ZUNO_SETUP_CHANNELS(...)
#define ZUNO_CUSTOM_CC(...)
#define ZUNO_SETUP_ASSOCIATIONS(...)
