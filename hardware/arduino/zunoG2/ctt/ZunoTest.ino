...
ZUNO_SETUP_USER_CODE_KEYS_COMMON(
	ZUNO_SETUP_USER_CODE_KEYS_INTERVAL(0, 99);
);

ZUNO_SETUP_USER_CODE_COMMON(
	ZUNO_SETUP_USER_CODE_SET_ENABLED('#', 48, 1, 9, 0, 1, 7, 9, 8),
	ZUNO_SETUP_USER_CODE_SET_AVAILABLE(),
	ZUNO_SETUP_USER_CODE_SET_AVAILABLE(),
	ZUNO_SETUP_USER_CODE_SET_AVAILABLE(),
	ZUNO_SETUP_USER_CODE_SET_AVAILABLE(),
	ZUNO_SETUP_USER_CODE_SET_AVAILABLE(),
...
ZUNO_SETUP_USER_CODE_MASTER(55, 66, 77, 99, 99);
...
ZUNO_SETUP_ENTRY_CONTROL_KEYS_COMMON(
	ZUNO_SETUP_ENTRY_CONTROL_KEYS_INTERVAL('0', '9');
	ZUNO_SETUP_ENTRY_CONTROL_KEYS_INTERVAL('#', '#');
	ZUNO_SETUP_ENTRY_CONTROL_KEYS_INTERVAL('*', '*');
);
