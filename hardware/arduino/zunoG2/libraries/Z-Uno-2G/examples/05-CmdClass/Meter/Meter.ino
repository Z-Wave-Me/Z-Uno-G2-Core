...
ZUNO_SETUP_CHANNELS(
	...
	ZUNO_METER(ZUNO_METER_TYPE_ELECTRIC, METER_RESET_ENABLE, ZUNO_METER_ELECTRIC_SCALE_KVAR, METER_SIZE_TWO_BYTES, METER_PRECISION_ONE_DECIMAL, ft_get_kvar, ft_get_kvar_reset)
);
