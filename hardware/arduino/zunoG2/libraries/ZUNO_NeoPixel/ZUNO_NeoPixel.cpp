...
const ZunoNeoBaseConfig_t NeoPixelClass::_configTable[] =
{
	#if USART_COUNT >= 1
	{
		...
		.dmaSignal = ldmaPeripheralSignal_USART0_TXBL,
	...
	#if USART_COUNT >= 2
	{
		...
		.dmaSignal = ldmaPeripheralSignal_USART1_TXBL,
	...
	#if USART_COUNT >= 3
	{
		...
		.dmaSignal = ldmaPeripheralSignal_USART2_TXBL,
	...
	#if USART_COUNT >= 2
	{
		...
		.dmaSignal = ldmaPeripheralSignal_TIMER0_UFOF,
	...
	},
	{
		...
		.dmaSignal = ldmaPeripheralSignal_TIMER1_UFOF,
	...
	},
	{
		...
		.dmaSignal = ldmaPeripheralSignal_WTIMER0_UFOF,
